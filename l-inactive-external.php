<?php 
    ...
    $title = "Completed Training External Participant";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-inactive-training-external.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">External Participant</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
