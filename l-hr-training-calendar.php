...
<html lang="en">
    ...
    <body class="nav-fixed bg-light">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">HR - Training Schedule</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="btn-list mb-4">
                                    <button class="btn btn-prasarana" type="button" id='all_training'>Training List</button>
        ...
        <script src="assets/js/page/jl-hr-training-calender.js"></script>
