...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jf-trainer-eval.js"></script>
    </head>
            ...
            <div class="pagetitle" >
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Trainer Assessment</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-subtitle mb-4">Review and fill in course evaluation below.</div>
                                    <form id='dataform' action="" method="post" autocomplete='off' name='dataform'>
                                        ...
                                        <?php include 'sub/evaluation/sub-trainer-evaluation-section-1-form.php'; ?>
                                        <?php include 'sub/evaluation/sub-trainer-evaluation-section-2-form.php'; ?>
