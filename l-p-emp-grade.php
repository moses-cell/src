<?php 
    ...
    $pages_name = "Employee Grade";
    $title = "Employee Grade Parameter";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-emp-grade.js"></script>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="btn-list mb-4">
                                    <button class="btn btn-prasarana" type="button" id='new'>New Employee Grade</button>
