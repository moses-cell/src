<?php 
    ...
    $title = "Cancelled Training Application";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-inactive-training-cancel.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Cancelled Training Application</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
