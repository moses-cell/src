...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-intern-allowance.js"></script>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Internship Student Allowance</li>
                    </ol>
            </div><!-- End Page Title -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <?php
                                    include 'sub/intern/sub-intern-allowance-list.php';
