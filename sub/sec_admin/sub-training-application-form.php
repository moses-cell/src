<form id='data_form' action="" method="post" autocomplete='off' name='data_form' enctype="multipart/form-data">
    ...
    <input type='hidden' id='staff_no' name='staff_no' value='<?php echo $staff_no; ?>' />
    ...
    <input type='hidden' id='super_no' name='super_no' value='<?php echo $super_no;?>' >
    <input type='hidden' id='appr_no' name='appr_no' value='<?php echo $appr_no;?>' >
    <input type='hidden' id='secretary_email' name='secretary_email' value='<?php echo $secretary_email;?>' >
    <input type='hidden' id='depoh_admin_email' name='depoh_admin_email' value='<?php echo $depoh_admin_email;?>' >
