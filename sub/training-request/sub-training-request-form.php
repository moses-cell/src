    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 ">
            <div class="row">  
                ...
                <div class="col-md-3 ">
                    <div class="form-group floating-label">
                        <input type="text" class="form-control allow_numeric" id="participant" name="participant"  placeholder="Enter No of Participant" />
                        <label for="maxseat">No of Participant</label>
                    </div>
                </div>
            </div>
        </div>
