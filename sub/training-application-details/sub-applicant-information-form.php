<form id='applicant_dataform' action="" method="post" autocomplete='off' name='applicant_dataform'>
    ...
    <div class="row mb-4"> <!-- Form Group (training title)-->
        ...
        <div class="col-md-6  floating-label">
            <input type="text" class="form-control" id="email2" name="email2"  placeholder="Enter Alternate Email Address" readonly />
    ...
    <input type="hidden" name="is_request" id="is_request">
