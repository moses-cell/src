<form id='data_form' action="" method="post" autocomplete='off' name='data_form' enctype="multipart/form-data">
    ...
    <div class="row mb-4">        
        ...
        <div class="col-md-3 ">
            <div class="form-group floating-label">
                <input type="text" class="form-control " id="trainingcategory" name="trainingcategory" readonly>
                <label class="mr-sm-2" for="trainingcategory">Training Category</label>
            </div>
        </div>
        <div class="col-md-3 ">
            <?php echo _checkbox_training_evaluation(true, true); ?>
        </div>
    </div>
    <!-- Form Row-->
    <div class="row mb-4">
        ...
        <div class="col-md-8 ">
            ...
            <div class="row">
                <div class="col-md-6 ">
                    <div class="form-group floating-label">
                        <input type="text" class="form-control" name="trainer" id="trainer" readonly> 
    ...
    <input type='hidden' id='super_eval' name='super_eval' value='' >
