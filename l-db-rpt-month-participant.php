<?php 
    ...
    $title = "Monthly Participant Training List " . date('F Y');
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-dashboard-admin-monthly-participant-list.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Montly Participant Training Register</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
