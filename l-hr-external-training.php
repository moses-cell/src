<?php 
    ...
    $pages_name = "External Training Request";
    $title = "";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-external-training-request.js"></script>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Staff Training Request</li>
                        <li class="breadcrumb-item active">External Training Request</li>
                    </ol>
            </div><!-- End Page Title -->
