<?php 
    ...
    $pages_name = "Food Preferences";
    $title = "Food Preferences List";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-food-preferences.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Food Preferences</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="btn-list mb-4">
                                    <button class="btn btn-prasarana" type="button" id='new'>New Food Preferences</button>
