<?php 
    ...
    require_once dirname(__FILE__)."/library/page/b_l-training-provider.php";
    
    $pages_name = "Training Provider";
    $title = "Training Provider List";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-training-provider.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Training Provider</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
