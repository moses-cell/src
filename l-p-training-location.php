<?php 
    ...
    require_once dirname(__FILE__)."/library/page/b_l-training-location.php";
    
    $pages_name = "Training Location";
    $title = "Training Location List";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-training-location.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Training Location</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
