<?php
	...
	$condition = " ta.trainer_eval > 2 and ts.trainer_id = '" . $_SESSION['trainer_id'] . "'";
	...
	if ($from == '' && $to == '') 
		...
		if ($title != '') {
			$condition = "ta.trainer_eval > 2 and ts.trainer_id = '" . $_SESSION['trainer_id'] . "' and ts.title = '" . $title . "' and (ts.date_start between '" . $from ."' and '" . $to . "')";	
		} else {
			$condition = " ta.trainer_eval > 2 and ts.trainer_id = '" . $_SESSION['trainer_id'] . "'";
		}
	}
