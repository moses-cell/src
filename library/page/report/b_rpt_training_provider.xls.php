<?php
	...
	$rpt = new c_report('');
	$sql = "Select id as 'Provider Id', provider_name as 'Training Provider', details as 'Training Provider Details', status as 'Status' from training_provider";
	$data = $rpt->_get_all_record($sql);


	$xlsTitle = "Prasarna Printis Training Provider";
	$xlsWSTitle = "Training Provider";
