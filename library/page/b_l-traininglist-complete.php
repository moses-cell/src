...
//	//$sql.= "p.ppc_status, p.ppc_submit_date, p.ppc_pm_by, p.ppc_appr_by, si.username ";
	...
	if ($from =='' && $to == '') {
		$condition = "staff_request != '1' and enable_schedule = '1' and ts.date_end <= '" . $to . "' ";
	} elseif ($from == $to) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ((ts.date_start"  . " between '" . $from ."' and '" . $to . "') or (date_end"  . " between '" . $from ."' and '" . $to . "')) and ts.date_end <= '" . $today . "' ";
	} elseif ($to == '' ) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ((ts.date_start"  . " between '" . $from ."' and '" . $to . "') or (date_end"  . " between '" . $from ."' and '" . $to . "')) and ts.date_end <= '" . $today . "' ";
	} elseif ($from == '' ) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ts.date_end <= '" . $to . "' ";
