<?php
	...
	if ($from =='' && $to == '') {
		$condition = "staff_request != '1' and enable_schedule = '1' and ts.date_end >= '" . date('Y-m-d') . "' ";
	} elseif ($from == $to) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ((ts.date_start"  . " between '" . $from ."' and '" . $to . "') or (date_end"  . " between '" . $from ."' and '" . $to . "'))";
	} elseif ($to == '' ) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ts.date_end >= '" . $from . "' ";
	} elseif ($from == '' ) {
		$condition = "staff_request != '1' and enable_schedule = '1' and ((ts.date_start"  . " between '" . date('Y-m-d') ."' and '" . $to . "') or (date_end"  . " between '" . date('Y-m-d') ."' and '" . $to . "'))";
	} else {
		$condition = "staff_request != '1' and enable_schedule = '1' and ((ts.date_start"  . " between '" . $from ."' and '" . $to . "') or (date_end"  . " between '" . $from ."' and '" . $to . "'))";
	}
