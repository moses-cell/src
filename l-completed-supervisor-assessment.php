<?php 
    ...
    $pages_name = "Completed Supervisor Assessment";
    $title = "";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-completed-supervisor-assessment.js"></script>
        ...
        <main id="main" class="main">
            <div class="pagetitle">
                ...
                <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Complete Supervisor Assessment</li>
                    </ol>
            </div><!-- End Page Title -->
