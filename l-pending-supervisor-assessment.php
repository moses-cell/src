<?php 
    ...
    $pages_name = "Pending Supervisor Assessment";
    $title = "";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-pending-supervisor-assessment.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Pending Supervisor Assessment</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                ...
                                <table id="datatable" class="display cell-border display cell-border masterTable" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200px">Supervisor Name</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
