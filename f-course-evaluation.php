...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jf-course-eval.js"></script>
    </head>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-subtitle mb-4">Review and fill in course evaluation below.</div>
                                    <form id='dataform' action="" method="post" autocomplete='off' name='dataform'>
                                        <?php include 'sub/evaluation/sub-staff-info-form.php'; ?>
                                        <?php include 'sub/evaluation/sub-course-evaluation-section-1-form.php'; ?>
                                        <?php include 'sub/evaluation/sub-course-evaluation-section-2-form.php'; ?>
                                        <?php include 'sub/evaluation/sub-course-evaluation-section-3-form.php'; ?>
