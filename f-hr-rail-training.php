<?php 
    ...
    $pages_name = "HR - Rail Training Form";
    $title = "Technical Rail Training";
    $sub_menu = "HRIT";
    $nav_index = "3";
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-4">
                                                   <label class="mr-sm-2" for="trainingcategory">Training Category</label>
                                                      <select class="custom-select " id="trainingcategory" name="trainingcategory">
                                                ...
                                                <div class="col-md-4">
                                                   <label class="mr-sm-2" for="whocanapply">Who Can Apply</label>
                                                    <select class="custom-select" id="whocanapply" name="whocanapply">
                                                        <option selected>Please select</option>
