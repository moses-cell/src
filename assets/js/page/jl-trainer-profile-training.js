...
function delete_training_record (id) {
    if (confirm('Are you you want to delete this record!')) {

        form_data = new Array();
        form_data.push({name: 'form_process' , value: 'delete-training'});
...
function load_training_history() {
	...
	$('#training_datatable').DataTable( {
        ...
        "columnDefs" : [
            ...
            { "targets" : 3, "orderable" : false, "searchable" : false, "width" : 50, "className" : "dt-body-right"},
        ],
        "ajax": "library/page/b_l-trainer-profile.php?id=" + id + '&training',
    });
