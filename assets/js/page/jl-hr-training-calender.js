$(document).ready(function() {
    ...
    $('#all_training').click(function() {
        location.href = 'l-hr-training.php';
    })
...
function get_calendar() {
    ...
    options = {
        events_source: 'library/page/b_c-hr-training-calender.php?cat=' + cat,
        view: 'month',
        tmpl_path: "tmpls/",
        tmpl_cache: false,
    ...
    $('#trainingcategory').change(function(){
         var cat = $('#trainingcategory').val();
        calendar.setOptions({events_source: 'library/page/b_c-hr-training-calender.php?cat=' + cat})
        //var calendar = $('#showEventCalendar').calendar(options);
...
/*(function($) {
    "use strict";
    var options = {
        events_source: 'library/page/b_c-hr-training-calender.php?name=azmir',
        view: 'month',
        tmpl_path: "tmpls/",
        tmpl_cache: false,
        day: formatdate('today', 2, 'date-only'),
