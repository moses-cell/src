...
function get_calendar() {
    ...
    options = {
        events_source: 'library/page/b_c-training-calender-unit.php?cat=' + cat,
        view: 'month',
        tmpl_path: "tmpls/",
        tmpl_cache: false,
    ...
    $('#trainingcategory').change(function(){
         var cat = $('#trainingcategory').val();
        calendar.setOptions({events_source: 'library/page/b_c-training-calender-unit.php?cat=' + cat})
        //var calendar = $('#showEventCalendar').calendar(options);
