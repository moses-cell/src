$(document).ready(function(){
	...
	$('#upload').click(function() {
		...
		$.confirm({
			...
			content: 'Are you sure you want to upload new training schedule.',
			useBootstrap: true,
			buttons: {
				yes: {
...
function upload() {
		...
		if (validateSave(form_data) == false) {
			...
			warning('Validation Failed', 'Please correct all the errors before training schedule can be uploaded');
			return;
		}

		form_data.append('form_process' , 'Training Schedule');
