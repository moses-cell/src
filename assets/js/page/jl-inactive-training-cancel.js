...
function update_table () {
    ...
    $('#datatable').DataTable( {
        ...
        "columnDefs" : [
            ...
            { "ordering" : true, "targets" :7, "orderable" : true, "width" : 200, },
            { "ordering" : true, "targets" :8, "orderable" : true, "width" : 100, },
        ...
        "ajax": "library/page/b_l-inactive-training-cancel.php?div=" + div + "&dept=" + dept + "&sec=" + sec + "&unit=" + unit + "&tcat=" + cat + "&sdt=" + sdt + "&edt="+edt
    } );
