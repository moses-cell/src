...
function update_table () {
    ...
    $('#datatable').DataTable( {
        ...
        "columnDefs" : [
            ...
            { "ordering" : true, "targets" :7, "orderable" : true, "width" : 250, },
            { "ordering" : true, "targets" :8, "orderable" : true, "width" : 50, },
            { "targets" : 9, "orderable" : false, "searchable" : false, "width" : 30, "className" : "dt-body-right"},
        ],
        "ajax": "library/page/b_l-inactive-training-reject.php?div=" + div + "&dept=" + dept + "&sec=" + sec + "&unit=" + unit + "&tcat=" + cat + "&sdt=" + sdt + "&edt="+edt
    } );
