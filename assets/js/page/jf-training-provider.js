 $(document).ready(function(){
	...
	$('#save').click(function() {
		...
		$.ajax({ //Process the form using $.ajax()
            ...
            url     : 'library/page/process/p_f-adm-training-provider.php', //Your form processing file URL
...
function populate_data() {
	...
	$.each(result.Data, function( key, value ) { 
		//alert(value['provider_name']);
		$('#provider_name').val(value['provider_name']);
...
function validateSave(form_data) {
	...
	validateElement('text','data_form','provider_name', 'Please enter Training Provider Name');
