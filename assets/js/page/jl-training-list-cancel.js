$(document).ready(function() {
    ...
    DateElement(true, getCurrentYear()-10, getCurrentYear()+1, 'sdate') //, '', '', '', true)
    DateElement(true, getCurrentYear()-10, getCurrentYear()+1, 'edate') //, '', '', '', true)
...
function update_table () {
    ...
    $('#datatable').DataTable( {
        ...
        "ajax": "library/page/b_l-traininglist-cancel.php?sdt=" + sdt + "&edt="+edt
    } );
}