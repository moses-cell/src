$(document).ready(function() {
    ...
    DateElement(false, getCurrentYear()-10, getCurrentYear(), 'sdate', 'edate');
    //DateElement(true, getCurrentYear()-10, getCurrentYear(), 'edate')
...
function update_table() {
    ...
    $('#datatable').DataTable( {
        ...
        "columnDefs" : [
                ...
                { "ordering" : true, "targets" :8, "orderable" : true, "width" : 130, },
                { "ordering" : true, "targets" :9, "orderable" : true, "width" : 130, },
                { "ordering" : true, "targets" :10, "orderable" : false, "width" : 30,  "className" : "dt-body-right"},
                
            ],
        "ajax": "library/page/b_l-trainer-completed-trainer-assessment.php?sdt=" + sdt + "&edt=" + edt + '&title=' + title
    } );
