$(document).ready(function() {
    ...
    DateElement(true, getCurrentYear() - 10, getCurrentYear(), 'sdate', '', '', yesterday , false)
    DateElement(true, getCurrentYear() - 10, getCurrentYear(), 'edate', '', '', yesterday, false)
...
function update_table () {
    ...
    $('#datatable').DataTable( {
        ...
        "ajax": "library/page/b_l-traininglist-complete.php?sdt=" + sdt + "&edt="+edt + "&tcat=" + cat
    } );
}