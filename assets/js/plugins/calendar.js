	...
	Calendar.prototype._init_position = function() {
		...
		switch(this.options.view) {
			...
			case 'month':
				...
				this.options.position.end.setTime(new Date(year, month, lastDay(year,month)+1).getTime());
				break;
			case 'day':
			...
			case 'string':
				if(source.length) {
					loader = function() {
						...
						//var params = {from: d_from.getTime(), to: d_to.getTime(), utc_offset_from: 0, utc_offset_to: 0};
