	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<form action="" method="post" autocomplete='off' class="login-form" name="frmlogin" id="frmlogin">
					...
					<div class="form-group d-flex">
						<input type="password" id="password" name="password" class="form-control rounded-left" placeholder="Password" required value="" data-toggle="tooltip" data-placement="top" title="Enter your password">
					</div>
					<div class="form-group">
						<button type="button" id="login" name="login" class="form-control btn btn-primary rounded submit px-3" onclick="">Login</button>
					</div>
					<div class="form-group d-flex">
