<?php 
    ...
    $title = "Yearly Participant Training List " . date('Y');
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-dashboard-admin-yearly-participant-list.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Yearly Participant Training Register</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php include 'sub/report/sub-report-parament-organization-month-category-form.php'; ?>
