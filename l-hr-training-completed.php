<?php 
    ...
    $title = "Completed Training Schedule List";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-training-list-complete.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Completed Training</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
