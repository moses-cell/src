<?php 
    ...
    $pages_name = "External Participant";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jf-hr-external-participant.js"></script>
    </head>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title mb-3"><?php echo $title; ?></div>
                                    <?php include 'sub/training-schedule/sub-external-participant-form.php'; ?>
