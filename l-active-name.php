<?php 
    ...
    $title = "Active Training by Staff Name";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    <head>
        ...
        <script src="assets/js/page/jl-active-training-name.js"></script>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Training List by Staff Name</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 text-start">
                                            <div class="input-group floating-label">
                                                <input type="text" class="form-control name_select" id="staff_name" name="staff_name"  placeholder="Enter Staff Name" />
                                                <label for="coursecode">Staff Name</label>
                                                <div class='staff_list' id='staff_list' style="width: 100%;"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 text-start">
