<?php 
    ...
    require_once dirname(__FILE__)."/library/page/b_l-my-staff-profile.php";    
    $roles = 'My Staff';
//    $authorize = check_user_access($roles);
    $pages_name = "Employee Profile";
    $title = "Prasarana Employee List In My Depoh";
    $sub_menu = "HRIT";
    $nav_index = "0";
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Depoh Staff</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
