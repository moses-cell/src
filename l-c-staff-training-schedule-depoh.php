<?php 
    ...
    $title = "Training Calender In My Section";
    $sub_menu = "HRIT";
    $nav_index = "0";
...
<html lang="en">
    ...
    <body class="nav-fixed bg-light">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Depoh Staff Training</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
        ...
        <script src="assets/js/page/jl-staff-training-calendar.js"></script>
